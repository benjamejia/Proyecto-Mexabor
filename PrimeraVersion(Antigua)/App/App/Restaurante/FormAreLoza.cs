...
namespace App
{
    public partial class FormAreLoza : Form
    {
        ...
        public void lozaEstructura()
        {
            ...
            for (int i = 0; i < radioButtons.Length; i += 2)
            {
                if (radioButtons[i].Checked || radioButtons[i + 1].Checked)
                {
                    ...
                    {
                        DataForms.areaLozaEstructura[index] = "1";
                    }
                    else
                    {
                        DataForms.areaLozaEstructura[index] = "0";
                    }
                    Checado = true;
                }
                else
        ...
        public void lozaLimpieza()
        {
            //For para verificar si hay alguna opcion en blanco.
            RadioButton[] radioButtons = {r17,r18,r19,r20,r21,r22,r23,r24,r25,r26,r27,r28,
                r29,r30};
            ...
            for (int i = 0; i < radioButtons.Length; i += 2)
            {
                if (radioButtons[i].Checked || radioButtons[i + 1].Checked)
                {
                    ...
                    if (radioButtons[i].Checked)
                    {
                        DataForms.areaLozaLimpieza[index] = "1";
                    }
                    else
                    {
                        DataForms.areaLozaLimpieza[index] = "0";
                    }
                    SegundoChecado = true;
                }
                else
        ...
        {
            FormPlanchas planchas = new FormPlanchas();
            this.Hide();
            planchas.Show();
        }
        ...
        private void FormAreLoza_Load(object sender, EventArgs e)
        {
            ...
            {
                int index = i / 2;
                if (DataForms.areaLozaEstructura[index] == "1")
                {
                    radioButtonsEstructura[i].Checked = true;
                }
                else if (DataForms.areaLozaEstructura[index] == "0")
                {
            ...
            {
                int index = i / 2;
                if (DataForms.areaLozaLimpieza[index] == "1")
                {
                    radioButtonsLimpieza[i].Checked = true;
                }
                else if (DataForms.areaLozaLimpieza[index] == "0")
                {
