namespace Mexabor.Almacen
{
    partial class Responsables
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Font = new Font("Yu Gothic", 15.75F);
            label1.Location = new Point(12, 83);
            label1.Name = "label1";
            label1.Size = new Size(153, 27);
            label1.TabIndex = 0;
            label1.Text = "Area de salida";
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.Font = new Font("Yu Gothic", 15.75F);
            label2.Location = new Point(12, 133);
            label2.Name = "label2";
            label2.Size = new Size(166, 27);
            label2.TabIndex = 1;
            label2.Text = "Cocina Caliente";
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Font = new Font("Yu Gothic", 15.75F);
            label3.Location = new Point(12, 191);
            label3.Name = "label3";
            label3.Size = new Size(132, 27);
            label3.TabIndex = 3;
            label3.Text = "Camara Fria";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.Font = new Font("Yu Gothic", 15.75F);
            ...
            label5.Font = new Font("Yu Gothic", 15.75F);
            ...
            label6.Font = new Font("Yu Gothic", 15.75F);
            ...
            label8.TabIndex = 254;
            label8.Text = "Seleccione a los Responsables de cada Area";
            // 
            // panel1
            // 
