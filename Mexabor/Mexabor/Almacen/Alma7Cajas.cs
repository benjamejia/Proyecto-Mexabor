...
namespace Mexabor.Almacen
{
    public partial class Alma7Cajas : Form
    {
        ...
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsAlmacen.cajasEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsAlmacen.cajasLimpieza, tlpL);
        }
        ...
        private void AlmaCajas_Load(object sender, EventArgs e)
        {
