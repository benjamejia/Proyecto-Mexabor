...
namespace Mexabor.Almacen
{
    public partial class Alma4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                CacheFormsAlmacen.almacenEstructura.Clear();
                CacheFormsAlmacen.almacenLimpieza.Clear();
                //Agregar el valor de la lista elemetnos a las listas
                CacheFormsAlmacen.almacenEstructura = elementos.GetRange(0, 8);
                CacheFormsAlmacen.almacenLimpieza = elementos.GetRange(8, 12);
