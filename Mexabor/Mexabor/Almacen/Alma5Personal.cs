...
namespace Mexabor.Almacen
{
    public partial class Alma5Personal : Form
    {
        public Alma5Personal()
        {
            ...
            RestaurarValoresDeCheckBox(CacheFormsAlmacen.areaPersonalEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsAlmacen.areaPersonalLimpieza, tlpL);
        }
        ...
        private void Alma5Personal_FormClosing(object sender, FormClosingEventArgs e)
        {
