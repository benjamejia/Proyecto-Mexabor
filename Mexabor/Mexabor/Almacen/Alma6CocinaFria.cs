...
namespace Mexabor.Almacen
{
    public partial class Alma6CocinaFria : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                CacheFormsAlmacen.cocinaFriaEstructura.Clear();
                CacheFormsAlmacen.cocinaFriaLimpieza.Clear();
                //Agregar el valor de la lista elemetnos a las listas
                CacheFormsAlmacen.cocinaFriaEstructura = elementos.GetRange(0, 7);
                CacheFormsAlmacen.cocinaFriaLimpieza = elementos.GetRange(7, 12);
