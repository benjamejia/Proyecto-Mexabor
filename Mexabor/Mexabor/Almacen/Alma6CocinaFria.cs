...
{
    public partial class Alma6CocinaFria : Form
    {
        public Alma6CocinaFria()
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsAlmacen.cocinaFriaEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsAlmacen.cocinaFriaLimpieza, tlpL);
        }
        ...
        {
            CacheFormsAlmacen.cocinaFriaEstructura = ObtenerValoresDeCheckBox(t1);
            CacheFormsAlmacen.cocinaFriaLimpieza = ObtenerValoresDeCheckBox(t2);
        }
        ...
        private void AlmaCocinaFria_Load(object sender, EventArgs e)
        {
        ...
        private void Alma6CocinaFria_FormClosing(object sender, FormClosingEventArgs e)
        {
