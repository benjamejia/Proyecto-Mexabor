...
namespace Mexabor
{
    public partial class Form9Juegos : Form
    {
        ...
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.juegosEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.juegosLimpieza, tlpL);
        }
        ...
        {
            CacheFormsRestaurante.juegosEstructura = ObtenerValoresDeCheckBox(t1);
            CacheFormsRestaurante.juegosLimpieza = ObtenerValoresDeCheckBox(t2);
        }
        ...
        private void Form9Juegos_FormClosed(object sender, FormClosedEventArgs e)
        {
        }

        private void Form9Juegos_FormClosing(object sender, FormClosingEventArgs e)
        {
