...
namespace Mexabor
{
    public partial class Form4Tortillas : Form
    {
        ...
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.tortillasEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.tortillasLimpieza, tlpL);
        ...
        private void Form4Tortillas_FormClosed(object sender, FormClosedEventArgs e)
        {
        }

        private void Form4Tortillas_FormClosing(object sender, FormClosingEventArgs e)
        {
