...
namespace Mexabor
{
    public partial class Form6Planchas : Form
    {
        ...
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.planchasEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.planchasLimpieza, tlpL);
        }
        ...
        private void Form6Planchas_FormClosed(object sender, FormClosedEventArgs e)
        {
        }

        private void Form6Planchas_FormClosing(object sender, FormClosingEventArgs e)
        {
