...
namespace Mexabor
{
    public partial class Form7Loza : Form
    {
        ...
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.lozaEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.lozaLimpieza, tlpL);
        }
        ...
        {
            CacheFormsRestaurante.lozaEstructura = ObtenerValoresDeCheckBox(t1);
            CacheFormsRestaurante.lozaLimpieza = ObtenerValoresDeCheckBox(t2);
        }
        ...
        private void Form7Loza_FormClosed(object sender, FormClosedEventArgs e)
        {
            
        }

        private void Form7Loza_FormClosing(object sender, FormClosingEventArgs e)
        {
