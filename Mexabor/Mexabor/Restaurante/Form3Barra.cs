...
namespace Mexabor
{
    public partial class Form3Barra : Form
    {
        ...
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.barraEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.barraLimpieza, tlpL);
        }
        ...
        private void Form3Barra_FormClosed(object sender, FormClosedEventArgs e)
        {
        }

        private void Form3Barra_FormClosing(object sender, FormClosingEventArgs e)
        {
