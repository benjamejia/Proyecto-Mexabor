...
namespace Mexabor
{
    public partial class Form5Servicios : Form
    {
        ...
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.serviciosEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.serviciosLimpieza, tlpL);
        }
        ...
        {
            CacheFormsRestaurante.serviciosEstructura = ObtenerValoresDeCheckBox(t1);
            CacheFormsRestaurante.serviciosLimpieza = ObtenerValoresDeCheckBox(t2);
        }
