...
namespace Mexabor
{
    public partial class Form8Banos : Form
    {
        ...
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.bañosEstructura, tlpE);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.bañosLimpieza, tlpL);
        }
        ...
        private void Form8Banos_FormClosed(object sender, FormClosedEventArgs e)
        {
        }

        private void Form8Banos_FormClosing(object sender, FormClosingEventArgs e)
        {
