...
namespace Mexabor
{
    public partial class Form10Personal : Form
    {
        ...
        {
            InitializeComponent();
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.personalPlanchas, planchasP);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.personalLoza, lozaP);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.personalAseo, aseoP);
            RestaurarValoresDeCheckBox(CacheFormsRestaurante.personalTortillas, tortillasP);
        }
